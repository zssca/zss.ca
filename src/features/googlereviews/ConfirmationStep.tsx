...
import { FiCheck, FiArrowLeft, FiArrowRight, FiStar, FiSend, FiZap, FiAward } from 'react-icons/fi';
...
const ConfirmationStep: React.FC<ConfirmationStepProps> = ({
  ...
  const planIcons = {
    'Basic': <FiStar className="h-6 w-6" />, // Updated to match PRICING_TIERS titles
    'Standard': <FiSend className="h-6 w-6" />,
    'Pro': <FiZap className="h-6 w-6" />,
    'Elite': <FiAward className="h-6 w-6" />,
  };
  ...
  return (
    <div className="bg-blue-50/10 rounded-lg border border-gray-200 shadow-sm p-4 max-w-4xl w-full mx-auto">
      ...
      <div className="text-center mb-6">
        ...
        <h3 className="text-xl font-semibold text-gray-900 tracking-tight">Confirm Your Review Boost</h3>
        <p className="text-xs text-gray-600">Check your plan details</p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        >
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs text-gray-500 bg-gray-50 px-2 py-0.5 rounded-full">One-Time Payment</span>
          </div>
          ...
          <div className="mb-4">
            ...
            {plan.deliveryTime && (
              <p className="mt-1 text-xs text-gray-600">Delivery: {plan.deliveryTime}</p>
            )}
          </div>

          <div className="border-t border-gray-200 pt-4">
            <h4 className="text-xs font-medium text-gray-600 uppercase tracking-wide mb-2">What You Get</h4>
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-4 flex flex-col">
          <h4 className="text-lg font-semibold text-gray-900 mb-6">Your Info</h4>
