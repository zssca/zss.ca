...
import { FiStar, FiZap, FiMapPin, FiUsers, FiShield, FiRefreshCw } from 'react-icons/fi';
...
const SERVICES: ServiceItem[] = [
  { title: 'Google Reviews Added', target: 2500, icon: <FiStar /> },
  { title: 'Businesses Boosted', target: 180, icon: <FiUsers /> },
  { title: 'Google Maps Optimized', target: 220, icon: <FiMapPin /> },
  { title: 'Reputation Refreshes', target: 140, icon: <FiRefreshCw /> },
  { title: 'Fast Review Deliveries', target: 190, icon: <FiZap /> },
  { title: 'Trust Scores Improved', target: 300, icon: <FiShield /> },
];
